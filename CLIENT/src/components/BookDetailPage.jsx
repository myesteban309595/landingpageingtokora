...
const BookDetailPage = () => {
  ...
  // Usar useEffect para obtener la cantidad de libros diferentes en el carrito
  useEffect(() => {
    const storedCart = JSON.parse(sessionStorage.getItem('cart')) || [];
    const uniqueBooks = new Set(storedCart.map(item => item.id));  // Usar Set para asegurar elementos únicos
  ...
  const handleAddToCart = () => {
    ...
    if (quantity <= book.stock) {  // Verificar si hay suficiente stock
      ...
      setCartItems(uniqueBooks.size); // Actualizar el número de libros diferentes en el carrito
